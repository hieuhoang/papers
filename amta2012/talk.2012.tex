...
\item{Run manually} 
   \\ Clean, lowercase data
   \\ Run word alignment
   \\ Train phrase-tables, language models, lexicalized reordering models
   \\ Tune
   \\ Test

\item{Use the EMS (Experiment Management System) } 
...
\item Difficult speed-up: Minimize memory usage
...
\slide{Optimizing Training}
\begin{center}

Use the latest version from github
  - less IO
  - less disk space
     - always zips intermediate training files
...
Using Mgiza
  - snt2cooc.pl for low memory laptops
...
Secondary phrase-table
  - backoff or concurrent

Forced alignment in MGIZA
