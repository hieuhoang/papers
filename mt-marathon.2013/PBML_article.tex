...
This paper describes this new feature function framework as implemented in the Moses decoder, a compares it with that implemented in cdec\cite{Dyer_etal_2010} and Joshua\cite{Joshua-Decoder}.
