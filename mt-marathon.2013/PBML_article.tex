...
\subsection{Old Framework}
The range of feature functions were hardcoded when evaluating the scores of hypotheses and translation rules. For example, a translation rule is scored according to Equation (1)
