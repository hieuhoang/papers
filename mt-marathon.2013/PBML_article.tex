...
Even though each decoder was created independently, their output are comparable. We see that be doing an indepth analysis of the working of each decoder and comparing their model score, we are able to transfer the best optmization technique from each decoder to the others.
