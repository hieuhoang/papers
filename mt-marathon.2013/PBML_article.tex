...
\end{split}
\end{equation}
where $\lambda_d$ is the distortion weight, and $R$ is the set of lexicalized reordering models.
%, and $score_{future}$ is the estimate of the future score for the hypothesis.
