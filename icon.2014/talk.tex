...
\item {\bf Tuning} 
  ...
  \item We can optimize the values of the feature weights such that translation quality is maximized on a held-out development set 
  \end{itemize}
\end{itemize}
%\vfill
...
\item {\bf Decoding}
  ...
  \item Pruning and reordering constraints to keep the task feasible
  \end{itemize}
\vspace*{-0.5ex}
...
\item {\bf Collect your data}
  ...
  \item Monolingual data
        ...
        \end{itemize}
  \item If not done yet, carry out sentence segmentation \\and parallel sentence alignment
%  \item Translation memories
  \end{itemize}
\item {\bf Build system}
\end{itemize}
\vfill
