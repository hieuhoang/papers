...
\littlecode{\normalsize http://www.statmt.org/moses/amta.2014.pdf} % TODO: upload slides
\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{New: OSM (Operations Sequence Model) }

\begin{itemize}
  \item A model that
  \begin{itemize}
    \item considers source and target contextual information across phrases
    \item integrates translation and reordering into a single model
  \end{itemize}
  \item Convert a bilingual sentence to a sequence of operations
  \begin{itemize}
    \item Translate (Generate a minimal translation unit)
    \item Reordering (Insert a gap or Jump)
  \end{itemize}
  \item P(e,f,a) = N-gram model over resulting operation sequences 
  \item Overcomes phrasal independence assumption
  \begin{itemize}
    \item Considers source and target contextual information across phrases 
  \end{itemize}
  \item Better reordering model
  \begin{itemize}
    \item Translation and reordering decisions influence each
    \item Handles local and long distance reorderings in a unified manner
  \end{itemize}
  \item No spurious phrasal segmentation problem
  \item Average gain of +0.40 on news-test2013 across 10 pairs
\end{itemize}
...
\begin{center}
 \includegraphics[scale=0.8]{osm.pdf}
\end{center}
...
\vspace{1cm}
\begin{itemize}
\item Incremental word alignment
\begin{itemize}
\item requires modified version of GIZA++\\
(available at http://code.google.com/p/inc-giza-pp/)
\item only works for HMM alignment (not the common IBM Model 4)
\end{itemize}
\item Translation model is defined by parallel corpus\\[5mm]
\begin{SaveVerbatim}{myverb}
...
\slide{Update Word Alignment}
\vspace{2cm}
\begin{itemize}
\item Uses original word alignment models\\
(with additional model files stored after training)
\item Incremental GIZA++ loads model
\item New sentence pairs is aligned on the fly
\item Typically, GIZA++ processes are run in both directions, symmetrized
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\slide{Update Translation Model}
\vspace{3cm}
\begin{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{Beyond Moses: CASMACAT Workbench}
%\vfill
\begin{center}
%\resizebox{\linewidth}{!}{
\includegraphics[scale=0.48]{casmacat-workbench.jpg}
%}
\end{center}
%\vfill
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{What is a Translation Rule?}

\begin{itemize}
  \item Phrase-table file:
  
    \begin{SaveVerbatim}{myverb}
  j' ai ||| I have ||| 0.1 0.2 0.3 0.4 ||| .....
  un ||| a ||| 0.1 0.2 0.3 0.4 ||| .....
  chat noir ||| black cat ||| 0.1 0.2 0.3 0.4 ||| .....
  \end{SaveVerbatim}
  \colorbox{gray}{\BUseVerbatim{myverb}}

  \item Use to translate:
  \begin{itemize}
    \item j' ai un chat noir .
    \item I have a black cat .
  \end{itemize}
  
  \item TODO draw hypotheses boxes here
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{Timeline of Translation Rule}

\begin{center}
\includegraphics[scale=0.6]{Feature_Function_API.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.6]{Feature_Function_API3.pdf}
\end{center}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{Feature Functions}

\begin{itemize}
  \item What is a feature function?
  \item Gives a score to a translation.
  \begin{itemize}
    \item partial translation
    \item completed
  \end{itemize}

  \item Example feature functions
  \begin{itemize}
    \item Language model
    \item Phrase penalty
    \item Word penalty
    \item Reordering model
    \item Phrase-table (special feature function)
    \item MANY MORE...
  \end{itemize}
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{Implementing a Feature Function}

\begin{SaveVerbatim}{myverb}
class MyFeatureFunction : public Stateless/Statefull...
{
  MyFeatureFunction(string ini-line)
...
\begin{center}
\includegraphics[scale=0.6]{Feature_Function_API2.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.65]{Feature_Function_API4.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.65]{Feature_Function_API5.pdf}
\end{center}
...
\begin{center}
\includegraphics[scale=0.65]{Feature_Function_API6.pdf}
\end{center}


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{Example Feature Functions}

\begin{itemize}
  \item Templates
  \begin{itemize}
    \item SkeletonStatelessFF
    \item SkeletonStatefulFF
    \item SkeletonLM
    \item SkeletonPT
  \end{itemize}
\end{itemize}
...
\begin{itemize}
  \item Video Demos
  \begin{itemize}
    \item Adding a Feature Function to Moses
    \item Compiling the Moses SMT toolkit with Eclipse
  \end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item Score a translation
  \end{itemize}
  \item Property
  \begin{itemize}
    \item Store arbitrary information in each translation rule
    \item Extra information
    \begin{itemize}
      \item Not just source, target, scores
      \item syntax/semantic information
      \item domain information
    \end{itemize} 
    \item can be used by any feature function
  \end{itemize}
...
\small
\begin{itemize}
  \item Standard translation rule
  ...
  \item With properties information

  \begin{SaveVerbatim}{myverb}
  j' ai ||| I have ||| 0.1 0.2 0.3 0.4 ||| ||| ||| ||| {{key value}}
  \end{SaveVerbatim}
  \colorbox{gray}{\BUseVerbatim{myverb}}
