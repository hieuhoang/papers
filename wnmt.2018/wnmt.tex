...
It is tempting to ignore these consideration, for example, by always decoding with a constant batch and beam size and ignoring hypotheses which are not needed. This is the strategy taken by other inference engines such as Marian, at the cost of lower translation speed due to wasteful processing.
