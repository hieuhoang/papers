...
\begin{description}
\item[\small 10:00-10:45 $\;\;$] {\bf Introduction} % TODO: should check whether this schedule is realistic
\item[\small 10:45-11:30 $\;\;$] {\bf Hands-on Session} --- you will need a laptop
\item[\small 12:00-13:30 $\;\;$] Lunch
\item[\small 13:30-12:00 $\;\;$] {\bf Advanced Topics}
\item[\small 13:00-Whenever $\;\;$] {\bf Up to you!}
\item[\small Tomorrow ALL DAY  $\;\;$] {\bf Up to you!}
\end{description}
...
\begin{itemize}
\small
  \item More detailed talks
  \item Extend Moses code
  \item Run hierarchical/syntax models
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includepdf[pages={1-26}]{hands-on.pdf}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\includepdf[pages={1-16}]{Basics.pdf}
