...
It has been noted by ~\citep{koehn-knowles:2017:NMT} and others that using n-best number of classes, rather than just the best class, improves translation quality. Unlike the 1-best case, however, the softmax calculation cannot be skipped as the denominator differs for each input.
