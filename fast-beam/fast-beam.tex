...
\end{tabular}
\caption{Time spent during translation (beam size 5)}
\label{fig:pie-time}
\end{figure} 
...
Fusing the softmax and beam search increase the speed of the output layer by 43\% for beam size 1, decreasing to 25\% for a beam of 10 when translating the Europarl dataset. This led to an overall increase in translation speed of up to 23\%, Figure~\ref{fig:europarl-beam}.

\begin{figure}
\centering
\begin{tabular}{cc}
{\includegraphics[scale=0.5]{europarl-beam.png}} 
\end{tabular}
\caption{Translation speed for Europarl dataset}
\label{fig:europarl-beam}
\end{figure} 
