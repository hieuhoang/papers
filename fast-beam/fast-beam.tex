...
We shall leave the maatrix multiplication for the next proposal and future work, and concentrate on the last three steps. There are algorithmic similarites between these steps, which we outline in ???.
