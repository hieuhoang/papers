...
As can be seen, the operations iterate over the matrix p five times - once to add the bias, three times to calculate the softmax, and once to search for the best class. We fuse the three operation into one kernel, a popular optimization technique~\citep{Guevara2009EnablingTP}.
