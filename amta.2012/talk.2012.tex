...
\vspace{30mm}
\begin{itemize}
\item Compile Moses with IRSTLM library \\[3mm]
\begin{SaveVerbatim}{myverb} 
./bjam --with-irstlm=[root dir of the IRSTLM toolkit] 
\end{SaveVerbatim}
\colorbox{gray}{\BUseVerbatim{myverb}}
\vspace{10mm}
\item Change ini file to use IRSTLM implementation \\[3mm]
\begin{SaveVerbatim}{myverb} 
[lmodel-file]
1 0 3 file/path
\end{SaveVerbatim}
...
\item {Create binary LM}\\[3mm]
\begin{SaveVerbatim}{myverb} 
  build_binary lm.arpa lm.binlm
\end{SaveVerbatim}
\colorbox{gray}{\BUseVerbatim{myverb}}

\item {Use in Moses}\\[3mm]
\begin{SaveVerbatim}{myverb} 
  [lmodel-file]
  9 0 5 lm.binlm
\end{SaveVerbatim}
...
\begin{SaveVerbatim}{myverb}
 ./moses -n-best-list n-best.file.txt [distinct] 100
\end{SaveVerbatim}
\colorbox{gray}{\BUseVerbatim{myverb}}
...
\slide{Things to look out for}
\begin{itemize}
\item Sparse features
\item Incremental model updating
\item Confidence measures
\item Open source computer aided translation\\
\includegraphics[width=10cm]{matecat-logo.png}
\includegraphics[width=10cm]{casmacat-logo.png}
\item Bigger, better, faster, more!
\end{itemize}
