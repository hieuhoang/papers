...
\date{\vspace{-5mm}4 November 2010}
\maketitle
...
\item[2002] $\;$\\[2mm] Pharaoh decoder, precursor to Moses (phrase-based models)
\item[2005] $\;$\\[2mm] Moses started by Hieu Hoang and Philipp Koehn (factored models)
\item[2006] $\;$\\[2mm] JHU workshop extends Moses significantly
\item[since late 2006] $\;$\\[2mm] Funding by EU projects EuroMatrix, EuroMatrixPlus
\item[2009] $\;$\\[2mm] Tree-based models implemented in Moses
\end{description}
...
\item others...
\end{itemize}
\item Code shared on Sourceforge
...
\item[Pangea] ---\\ language service provider builds Moses systems for its data
\end{description}
