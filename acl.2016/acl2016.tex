...
\end{figure} 
We will use the Probing phrase-table (???) exclusively in our work as this appears to have the fastest translation rule lookup, especially with large number of cores.
