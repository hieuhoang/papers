...
\begin{enumerate}
  ...
  \item coverage and end position of most recent translated source word.
\end{enumerate}
Table~\ref{tab:stack-configuration-model-score} present the average model on the held out test set, while Table~\ref{tab:stack-configuration-time} presents the decoding time.
\begin{table}[h]
\tiny
\begin{center}
\begin{tabular}{|r|p{12mm}|p{12mm}|p{13mm}|} \hline
Pop-limit	& Coverage \newline cardinality	& Coverage	& Coverage \newline \& end pos \\ \hline
100  		& -8.64513 			& -8.64513	& -8.64513 \\
500		& -8.59563			& -8.59563 	& -8.59612 \\
1,000	 	& -8.58700			& -8.58700	& -8.5870 \\ 
5,000 		& -8.58165			& -8.58165	& -8.58098 \\ 
10,000 		& -8.58133			& -8.58133	& -8.58015 \\ 
15,000 		& -8.58130			& -8.58130	& -8.57999 \\ 
20,000 		& -8.58130			& -8.58130	& -8.57994 \\ \hline
\end{tabular}
\end{center}
\caption{Average model scores for different stack configurations}
\label{tab:stack-configuration-model-score}
\end{table}
...
500		& 237			& 225 	& 229 \\
1,000	 	& 416			& 397	& 423 \\ 
5,000 		& 1,930			& 1031	& 2153 \\ 
10,000 		& 3,619			& 3630	& 4576 \\ \hline
\end{tabular}
\end{center}
\caption{Decoding time with 32-threads for different stack configurations (sec)}
\label{tab:stack-configuration-time}
\end{table}
...
\end{tabular}
\caption{Analysis and Generation Translation Model}
\label{fig:analysisAndGen}
\end{figure} 
