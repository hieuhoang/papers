...
A number of the decoders support multithreading whilst others use alternative methods such as Hadoop or external scripts to parallelize decoding. As we shall see in the Results Section, there are severe limitations to parallelizing using a external scripts to exectute multiple decoding processes.

(mtplz) is perhaps closest in intent to this work. It describes a novel 
