...
We verify the results on a smaller French-English phrase-based model and test set container longer sentences. The speed gain is even greater than our main testing scenario, Figure~\ref{fig:fr-en-speed}.
\begin{figure}[h]
\centering
\begin{tabular}{cc}
