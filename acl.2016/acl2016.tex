...
It has been suggested that using a larger language model would overpower the improvements in decoding speed. We tested this posit by replacing the language model in our ar-en experiment with a 96GB language model. Results show that the decoding speed compared to Moses is less than with a smaller language model, Figure~\ref{fig:large-lm}, however, our work still scales monotonically until all CPUs are saturated, unlike Moses.
\begin{figure}[h]
\centering
\begin{tabular}{cc}
