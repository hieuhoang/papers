...
Coverage			&		& -8.58635 \\
Coverage \& end position	&		& -8.58263 \\ \hline
\end{tabular}
\end{center}
...
\end{table}
From the results in Table~\ref{tab:queue-configuration}, using finer grain queues results in better model scores, it is significantly slower to decode.
