...
Of these feature functions, we will focus on optimizing only the phrase-table and lexicalized re-ordering model.
...
We will also investigate two other optimizations described below.
