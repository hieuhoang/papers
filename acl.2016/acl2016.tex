...
\end{equation}
where the \emph{arg max} function is the search. The log-linear model generalizes the noisy channel model to include more component models and weighting each model according to the contribution of each model to the total probability. 
\begin{equation}
\label{eq:Log-Linear}
