...
This contrast with Moses where speed increases to approximately 16 threads but then actually become slower thereafter, Figure~\ref{fig:moses-speed}. Using the tcmalloc library has a small effect on decoding speed. 
\begin{figure}[h]
\centering
\begin{tabular}{cc}
