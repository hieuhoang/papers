...
\end{center}
\item Requires boost library
\item Does not currently work for:
\begin{itemize}
\item syntax-based decoding
\item IRSTLM
\item randLM
\end{itemize}
\end{itemize}
...
\item But:
	...
	\item large load time
	\end{itemize}
\item IRSTLM and RandLM especially designed to tackle large data issues
\end{itemize}
...
\vspace{10mm}
\begin{itemize}
\item Another training toolkit for large corpora
	\begin{itemize}
	\item faster
	\item very small memory usage
	\end{itemize}
\item Training: \\
\begin{SaveVerbatim}{myverb} 
...
\item \littlecode{-S memory} = How much memory to use.
	      \begin{itemize}
		\item NUM\% = percentage of physical memory
		\item NUM[b/K/M/G/T]
	      \end{itemize}
\end{itemize}
...
\begin{itemize} 
  ...
  \item Contraint \\
  Only use translations from phrase-table if it match XML\\
\end{itemize}
...
\begin{itemize} 
  \item learnt good translations from training data
...
\littlecode{\example{Microsoft} <option translation="\example{Windows}"> \example{Windows}
 ...
 i.e. do not use any translation unless it contains the word 'Windows'
...
Translate:
\begin{itemize}
  \item You owe me a 100 dollars !
  \item You owe me a 200 dollars !
  \item You owe me a 9.56 dollars !
\end{itemize}
Problem: \\
...
Placeholder:
\begin{itemize}
  \item  \littlecode{You owe me a @num@ dollars !}
\end{itemize}
...
Replace with
\begin{itemize}
  \item \littlecode{You owe me a  <ne translation="@num@" entity="100">@num@</ne> dollars !}
\end{itemize}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\slide{Hierarchical Model Training}
\vspace{5mm}
\begin{itemize}
\item Command line
\begin{center}
